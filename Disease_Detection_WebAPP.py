...
Pretty simple project , User can choose whatever data he wants to display , the type of Machine Learning model he wants to use and then use variables at the left to see if the output will change (0 : probably not sick , 1 : probably sick) , the user can display the correlation matrix to see which variable will make a change in the output ! Hope you like My project , Have Fun !\n
By Hamza LAMTOUNI
""")
